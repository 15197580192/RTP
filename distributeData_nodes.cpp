...
int main(){
    ifstream fin1("./output/new_SF0.1/region_node_component_6_v2.txt");
    string line;
    int line_cnt = 0;
    ...
    ifstream fin2("./output/new_SF0.1/new_output_nodes.txt");
    string node_line;
    int node_cnt = 0;
    ...
    while (now_partition_id < 6){
        ...
        string fout_name0 = "./output/new_SF0.1/partition_txt/partition_" + to_string(now_partition_id) + "/" + file_label_list[0] + "_0_0.txt";
        string fout_name1 = "./output/new_SF0.1/partition_txt/partition_" + to_string(now_partition_id) + "/" + file_label_list[1] + "_0_0.txt";
        string fout_name2 = "./output/new_SF0.1/partition_txt/partition_" + to_string(now_partition_id) + "/" + file_label_list[2] + "_0_0.txt";
        string fout_name3 = "./output/new_SF0.1/partition_txt/partition_" + to_string(now_partition_id) + "/" + file_label_list[3] + "_0_0.txt";
        string fout_name4 = "./output/new_SF0.1/partition_txt/partition_" + to_string(now_partition_id) + "/" + file_label_list[4] + "_0_0.txt";
        string fout_name5 = "./output/new_SF0.1/partition_txt/partition_" + to_string(now_partition_id) + "/" + file_label_list[5] + "_0_0.txt";
        string fout_name6 = "./output/new_SF0.1/partition_txt/partition_" + to_string(now_partition_id) + "/" + file_label_list[6] + "_0_0.txt";
        string fout_name7 = "./output/new_SF0.1/partition_txt/partition_" + to_string(now_partition_id) + "/" + file_label_list[7] + "_0_0.txt";
