...
int main(int argc, char** argv) {
    ...
    string file_path = "./queries/dbpedia-6-other.txt";
        ...
        if (i == 2) {
            ...
            if (world_rank == 0) {
                ...
                for (int j = 0; j < query1Results.size(); j++) {
                    if (j == 0) {
                        tid2 = tid2 + query1Results[j].nodeId;
                    }
                    else {
                        tid2 = tid2 + ", " + query1Results[j].nodeId;
                    }
