        ...
        if (pos == -1) {
            ...
            switch (now_num) {
                case 0:
                    ...
                    break;
                case 1:
                    q3.personFirstName = now_str;
                    break;
                case 2:
                    q3.personLastName = now_str;
                    break;
                case 3:
                    q3.replyCount = stoll(now_str);
                    break;
                case 4:
                    q3.tagNames = now_str;
                    break;
    ...
    for (int i = 0; i < query_list.size(); i++) {
        ...
        if (i == 2) {
            ...
            for(int j=0;j<query1Results.size();j++){
                str3+=query1Results[j].tag.id;
                if(j!=query1Results.size()-1) str3+=',';
            }
            str3+="] AS tags\n";
            str1=str3+str1;
