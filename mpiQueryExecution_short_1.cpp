...
void print(Query1Result q) {
    cout << "---------------------------------------" << endl;
    cout << "'firstName': " << q.firstName << ", 'lastName': " << q.lastName << ", 'birthday': " << q.birthday << ", 'locationIP': " << q.locationIP;
    cout << ", 'browserUsed': " << q.browserUsed << ", 'cityId': " << q.cityId << ", 'gender': " << q.gender << ", 'creationDate': " << q.creationDate << endl;
}
...
int main(int argc, char** argv) {
    ...
    string file_path = "./queries/interactive-short-1.txt";
    string neo4jResult;
    ...
    for (int i = 0; i < query_list.size(); i++) {
        ...
        //cout << "now_query: " << query_list[i] << endl;  //comment
        if (i == 0) {
            ...
            if (world_rank == 0) {
                ...
                for (int j = 0; j < results.size(); ++j) {
                    //cout << "从节点 " << (j + 1) << " 收到的结果: " << results[j] << " " << results[j].length() << endl; // comment
                ...
                //cout << "query1_ans_list: " << query1_ans_list.size() << endl;  // comment
