...
void print(Query1Result q) {
    cout << "---------------------------------------" << endl;
    cout << "'messageCreationDate': " << q.messageCreationDate << ", 'messageContent': " << q.messageContent << endl;
}
...
int main(int argc, char** argv) {
    ...
    string file_path = "./queries/interactive-short-4.txt";
    string neo4jResult;
