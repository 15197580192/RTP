...
int main(int argc, char** argv) {
    ...
    string file_path = "./queries/dbpedia-3-other.txt";
    ...
    for (int i = 0; i < query_list.size(); i++) {
        ...
        if (i == 3) {
            ...
            if (world_rank == 0) {
                ...
                // cout << query2Other_ans_list[0] << endl;
                ...
                for (int j = 0; j < query2Other_ans_list.size(); j++) {
                    ...
                    for (int k = 0; k < query2Results.size(); k++) {
                        if (query2Results[k].nodeId == q2.nodeId) {
                            flag = true;
                            break;
                        }
                    }
                ...
                for (int j = 0; j < query2Results.size(); j++) {
                    ...
                    tid2 = tid2 + ", " + query2Results[j].nodeId;
                }
                tid2 = tid2 + "]\n";
                // cout << "tid: " << tid << endl;
            } else {
