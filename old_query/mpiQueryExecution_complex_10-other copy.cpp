    ...
    for (int i = 0; i < query_list.size(); i++) {
        ...
        if (i == 2) {
            ...
            if (world_rank == 0) {
                ...
                for (int j = 0; j < query1Other_ans_list.size(); j++) {
                    ...
                    if (tmonth == 5 && tday >= 21) {
                        ...
                        for (int k = 0; k < query1OtherResults.size(); k++) {
                            if (query1OtherResults[k].friendPerson.id == q1.friendPerson.id) {
                                flag = true;
                                break;
                            }
                        }
                ...
                int cnt = 0;
                for (int j = 0; j < query1OtherResults.size(); j++) {
                    bool flag1 = false;
                    for (int k = 0; k < query1Results.size(); k++) {
                        if (query1OtherResults[j].friendPerson.id == query1Results[k].friendPerson.id) {
                            flag1 = true;
                            break;
                        }
                    }
                    if (flag1 == false) {
                        if (cnt == 0) {
                            tid2 = tid2 + query1OtherResults[j].friendPerson.id;
                        }
                        else {
                            tid2 = tid2 + ", " + query1OtherResults[j].friendPerson.id;
                        }
