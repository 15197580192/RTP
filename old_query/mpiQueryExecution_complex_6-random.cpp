...
Query3Result parseQuery3Results(string data) {
    ...
    for (int i = 0; i < sub_data.size(); i++) {
        ...
        if (i == 0) {
            ...
            string tfid = sub_data[i].substr(pos + 2);
            // cout << "tfid: " << tfid << endl;
            q3.friendId = tfid;
        }
        if (i == 1) {
...
int main(int argc, char** argv) {
    ...
    string file_path = "./queries/interactive-complex-6-random.txt";
    string neo4jResult;
    string tid = " ";
    string pid = " ";
    int tid_length = 0;
    ...
    for (int i = 0; i < query_list.size(); i++) {
            ...
            if (world_rank != 0) {
                ...
                for (int j = 0; j < query2_ans_list.size(); j++) {
                    ...
                    for (int k = 0; k < query3Results.size(); k++) {
                        if (q2.friendPerson.id == query3Results[k].friendId) {
                            if (cnt == 0) {
                                pid = pid + query3Results[k].friendPost.id;
                            }
                            else {
                                pid = pid + ", " + query3Results[k].friendPost.id;
                            }
        ...
        if (i == 3) {
            ...
            if (world_rank != 0) {
                ...
                cout << query1Results[0].knownTagId << endl;
