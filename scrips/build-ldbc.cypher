...
FIELDTERMINATOR '|' 
MATCH (comment1:Comment {id: csvline.Comment_id1}), (comment2:Comment {id: csvline.Comment_id2})
CREATE (comment1)-[:replyOf]->(comment2);

USING PERIODIC COMMIT 10000       
load csv with headers 
FROM "file:///comment_replyOf_post_0_0.csv" AS csvline
FIELDTERMINATOR '|' 
MATCH (comment:Comment {id: csvline.Comment_id}), (post:Post {id: csvline.Post_id})
...
FIELDTERMINATOR '|' 
MATCH (forum:Forum {id: csvline.Forum_id}), (person:Person {id: csvline.Person_id})
...
FIELDTERMINATOR '|' 
MATCH (forum:Forum {id: csvline.Forum_id}), (person:Person {id: csvline.Person_id})
CREATE (forum)-[r:hasModerator]->(person);
...
FIELDTERMINATOR '|' 
MATCH (person:Person {id: csvline.Person_id}), (tag:Tag {id: csvline.Tag_id})
CREATE (person)-[r:hasInterest]->(tag);
...
FIELDTERMINATOR '|' 
MATCH (person1:Person {id: csvline.Person_id1}), (person2:Person {id: csvline.Person_id2})
MERGE (person1)-[r:knows]->(person2)
ON CREATE SET r.creationDate = csvline.creationDate
MERGE (person2)-[r1:knows]->(person1)
ON CREATE SET r1.creationDate = csvline.creationDate;

USING PERIODIC COMMIT 10000       
load csv with headers 
FROM "file:///person_likes_comment_0_0.csv" AS csvline
FIELDTERMINATOR '|' 
MATCH (person:Person {id: csvline.Person_id}), (comment:Comment {id: csvline.Comment_id})
...
FIELDTERMINATOR '|' 
MATCH (person:Person {id: csvline.Person_id}), (post:Post {id: csvline.Post_id})
...
FIELDTERMINATOR '|' 
MATCH (tagclass1:Tagclass {id: csvline.TagClass_id1}), (tagclass2:Tagclass {id: csvline.TagClass_id2})
